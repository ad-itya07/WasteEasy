...
import { materialData } from "@/raw-data/MaterialData";
      ...
      {loading ? (
        ...
        <>
          {true ? (
            <section className=" p-2 flex flex-col gap-8 relative">
              <div className="flex items-center justify-between ">
                ...
                <div className="flex gap-3">
                  ...
                  />
                  <div
                    className={` w-44 h-56 z-50 overscroll-y-scroll absolute bg-white ${
                      openNotification ? " scale-100" : "scale-0"
                    } duration-200 rounded-lg top-16 shadow-md shadow-black/40 right-5 border-2 border-black/10`}
                  ></div>
                </div>
              </div>
              ...
              <div className=" bg-green-600 shadow-2xl p-6 shadow-black/30 rounded-lg w-full ">
                <div className="flex items-center justify-between gap-4 p-4 text-white">
                  <div className="flex flex-col justify-center items-center">
                    <div className="border-2 rounded-full p-3 mb-2">
                      <Landmark size={32} />
                    </div>
                    <span className=" font-semibold uppercase text-lg">
                      {user?.userData.totalPointsEarned || "STATIC DATA"}
                    </span>
                  ...
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <span className=" font-semibold uppercase text-lg">
                      {"STATIC-DATA::"}G{/* calculateTotalCO2Saved() */}
                    </span>
                    <span className="  uppercase text-xs opacity-70 font-semibold tracking-wider">
                      Saved CO2
                    </span>
                  ...
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <span className=" font-semibold uppercase text-lg">
                      {user?.userData?.wasteDumped?.length || "STATIC DATA"}
                    </span>
                    <span className="  uppercase text-xs opacity-70 font-semibold tracking-wider">
                      Recycled
                    </span>
            ...
            <h1 className=" text-3xl font-bold text-red-500 min-h-screen">
